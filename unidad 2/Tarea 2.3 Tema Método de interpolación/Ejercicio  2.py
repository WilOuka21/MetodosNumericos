...
# Selección de tres puntos adecuados dentro del intervalo [-2.3, 3.2]
x0 = -2.3
x1 = 1.7
x2 = 3.2
...
axs[0].plot(np.linspace(x0, x2, 100), f(np.linspace(x0, x2, 100)), label="$f(x) = e^{-x} - x$", linestyle='dashed', color='blue')
