...
def gauss_seidel(A, b, tol=1e-6, max_iter=100):
    n = len(b)
    # Valor inicial inicia en 0 por default
    x = np.zeros(n)
    x_prev = np.copy(x)
    errors = []
...
A = np.array([
    ...
    [-3, -1, 22, -5, 0],
    [0, -2, -4, 25, -1],
    [0, 0, 0, 0, 0] # Agrega una fila de ceros para completar la matriz 5x5
])

b = np.array([100, 120, 130, 150, 0]) # Agrega un cero para completar el vector b de 5 elementos
