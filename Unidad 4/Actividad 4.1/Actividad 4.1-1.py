...
x_vals = np.arange(0, np.pi, 0.1)  # Intervalo [0, π] con paso h=0.1
...
ax[0].plot(x_vals, f(x_vals), '-', label='Función f(x) = sin(x)')
ax[0].plot(x_vals, df_exact, 'k-', label='Derivada Analítica f\'(x) = cos(x)')
